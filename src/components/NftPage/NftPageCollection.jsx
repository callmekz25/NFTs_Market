...
const NFTPageCollection = () => {
    ...
    const { artistNameThat } = useParams();

    const [artist, setArtist] = useState(null);

    useEffect(() => {
        const foundArtist = ListTrendingCollection.find(
            (artist) => artist.name === artistNameThat
        );
            ...
            <div className="lg:px-[150px] md:px-[70px] px-[30px] bg-[#2b2b2b] py-[40px]">
                ...
                <div className="py-[40px] lg:py-[80px]">
                    <div className="flex items-center justify-between">
                        ...
                        <Link to={`/artist-collection/${artist.name}`}>
                            <button
...
export default NFTPageCollection;
