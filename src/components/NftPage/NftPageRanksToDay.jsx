...
import LinkRankToDay from "../RankingPage/ListRanking/RankToday";
const NFTPageRanksToDay = () => {
    ...
    useEffect(() => {
        const foundArtist = LinkRankToDay.find(
...
export default NFTPageRanksToDay;
