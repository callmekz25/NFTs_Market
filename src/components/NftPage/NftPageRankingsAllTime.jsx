...
import LinkRankAllTime from "../RankingPage/ListRanking/RankAllTime";
const NFTPageRanksAllTimes = () => {
    ...
    useEffect(() => {
        const foundArtist = LinkRankAllTime.find(
            ...
            <div className="lg:px-[150px] md:px-[70px] px-[30px] bg-[#2b2b2b] py-[40px]">
                ...
                <div className="py-[40px] lg:py-[80px]">
                    <div className="flex items-center justify-between">
                        ...
                        <Link to={`/artist-all-time/${artist.name}`}>
                            <button
...
export default NFTPageRanksAllTimes;
