...
import ListRankWeek from "../RankingPage/ListRanking/RankWeek";
const ArtistPageRankingsWeek = () => {
    ...
    useEffect(() => {
        const foundArtist = ListRankWeek.find(
                ...
                <div className="py-[80px] bg-[#3B3B3B] lg:px-[150px] md:px-[70px] px-[30px] ">
                    <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30px]">
                        <Created
                            ...
                            duration="1500"
                            data={artist}
                            path={`/artist-week/${artist.name}/nft/${artist.name}`}
                        />
                        <Created
                            styleAos="zoom-in"
                            duration="1500"
...
export default ArtistPageRankingsWeek;
