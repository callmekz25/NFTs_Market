...
import ListRankAllTime from "../RankingPage/ListRanking/RankAllTime";
const ArtistPageRankingsAllTime = () => {
    ...
    const { artistNameRankingsAllTime } = useParams();

    const [artist, setArtist] = useState(null);

    useEffect(() => {
        const foundArtist = ListRankAllTime.find(
            (artist) => artist.name === artistNameRankingsAllTime
        );
        setArtist(foundArtist);
    }, [artistNameRankingsAllTime]);

    if (!artist) {
        return <div className="text-[20px]">Error !</div>;
    }
                ...
                <div className="py-[80px] bg-[#3B3B3B] lg:px-[150px] md:px-[70px] px-[30px] ">
                    <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30px]">
                        <Created
                            ...
                            duration="1500"
                            data={artist}
                            path={`/artist-all-time/${artist.name}/nft/${artist.name}`}
                        />
                        <Created
                            styleAos="zoom-in"
                            duration="1500"
...
export default ArtistPageRankingsAllTime;
