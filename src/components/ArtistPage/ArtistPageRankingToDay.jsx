...
import ListRankToDay from "../RankingPage/ListRanking/RankToday";
const ArtistPageRankingsToDay = () => {
    ...
    const { artistNameRankingsToDay } = useParams();

    const [artist, setArtist] = useState(null);

    useEffect(() => {
        const foundArtist = ListRankToDay.find(
            (artist) => artist.name === artistNameRankingsToDay
        );
        setArtist(foundArtist);
    }, [artistNameRankingsToDay]);
                ...
                <div className="py-[80px] bg-[#3B3B3B] lg:px-[150px] md:px-[70px] px-[30px] ">
                    <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30px]">
                        <Created
                            ...
                            duration="1500"
                            data={artist}
                            path={`/artist-today/${artist.name}/nft/${artist.name}`}
                        />
                        <Created
                            styleAos="zoom-in"
                            duration="1500"
...
export default ArtistPageRankingsToDay;
