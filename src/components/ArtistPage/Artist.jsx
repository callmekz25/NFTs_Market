...
const Artist = () => {
    ...
    // Tạo state để lưu trữ dữ liệu của artisbt khi tìm thấy trong mảng
    const [artist, setArtist] = useState(null);

    // Tìm artist.name nào trong mảng khớp với name URL khi click bên ListTopArtist thì setArtist dữ liệu object để render
    useEffect(() => {
        const foundArtist = TopArtists.find(
                ...
                <div className="py-[80px] bg-[#3B3B3B] lg:px-[150px] md:px-[70px] px-[30px] ">
                    <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30px]">
                        <Created
                            ...
                            duration="1500"
                            data={artist}
                            path={`/artist/${artist.name}/nft/${artist.name}`}
                        />
                        <Created
                            styleAos="zoom-in"
                            duration="1500"
